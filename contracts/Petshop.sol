...
contract Petshop {
  ...
  modifier notAnOwner {
    require(msg.sender != shopOwner, "Only owner cannot call this function");
    _;
  }
  ...
  function buy(uint petId) external payable notAnOwner {
    ...
    require(petInfos[petId].buyer == address(0), "This one is already sold"); //check condition that no one buy this pet before
